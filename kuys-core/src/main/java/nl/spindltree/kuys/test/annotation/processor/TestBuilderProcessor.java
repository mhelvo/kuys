package nl.spindltree.kuys.test.annotation.processor;
...
@SupportedAnnotationTypes("nl.spindltree.kuis.test.TestBuilder")
...
public class TestBuilderProcessor extends AbstractProcessor {
    ...
    private void generateForElement(ExecutableElement element) {
        try {
            ...
            Template template = template("nl/spindltree/annotation/test/TestBuilder.ftl");
